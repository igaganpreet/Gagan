...
$(function() {
    ...
    function checkToggle(e) {
        ...
        if (itemClicked.classList.contains("navLink")) {
            toggleHamburger()
        }
    }

    navbardiv.addEventListener("click", checkToggle)
